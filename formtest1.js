...
let all_program = function () {
  //再読み込み時、データを格納する。
  dict_LCdata = create_LCdata(test_data);
  graph_data = graph_Summarize(dict_LCdata);
  ...
  })(
    {
      ...
      "5i0G": [
        function (require, module, exports) {
          ...
          var qn =
              Q && "documentMode" in document && 11 >= document.documentMode,
            Yn = {
              select: {
                phasedRegistrationNames: {
                  bubbled: "onSelect",
            ...
            function d(e, t, n) {
              ...
              if ("object" == typeof t && null !== t) {
                switch (t.$$typeof) {
                  case Xe:
                    return (
                      ((n = il(t.type, t.key, t.props, null, e.mode, n)).ref =
                        Cl(e, null, t)),
                      (n.return = e),
                      n
                    );
          ...
          function pi(e, t) {
            var n = e.alternate;
            return (
              null !== n && t === n.updateQueue && (t = e.updateQueue = ui(t)),
              t
            );
          }
            ...
            switch (r.tag) {
              ...
              case ni:
                if (
                  null ==
                  (a =
                    "function" == typeof (e = r.payload) ? e.call(i, l, a) : e)
                )
                  break;
                return t({}, l, a);
              case li:
          ...
          function ao(e, t) {
            ...
            (Vi = qi = !1),
              ...
              (r = t.expirationTime),
              0 === (t = (t = t.childExpirationTime) > r ? t : r) &&
                (Zi = null),
              Wo(e, t);
          }
          function io(e) {
          ...
          function uo(e, t) {
                      ...
                      if (
                        ...
                        do {
                          if (13 === f.tag) {
                            ...
                            "number" ==
                              typeof (h = f.pendingProps.maxDuration) &&
                              (0 >= h
                                ? (p = 0)
                                : (-1 === p || h < p) && (p = h));
                          }
            ...
            if (((Vi = !1), (Li.current = n), (Ga = Xa = Ya = null), fa(), a))
              ...
              if (
                (null === (n = e.current.alternate) && l("281"),
                (Bi = null),
                Ki)
              ) {
                if (
          ...
          function co(e, t) {
            ...
            3 === e.tag &&
              (fi(e, (n = Di(e, (n = yi(t, e)), 1073741823))),
              ho(e, 1073741823));
          }
          function so(e, t) {
                ...
                do {
                  switch (o.tag) {
                    ...
                    case 1:
                      if (Hr(o.type)) {
                        o =
                          o.stateNode.__reactInternalMemoizedMergedChildContext;
                        break t;
                      }
                  }
                  o = o.return;
          ...
          (Pe = function (e, t, n) {
            ...
            (au.prototype.commit = function () {
              var e = this._root._internalRoot,
                t = e.firstBatch;
              if (
                ((this._defer && null !== t) || l("251"), this._hasChildren)
              ) {
            ...
            (ou.prototype.legacy_renderSubtreeIntoContainer = function (
              e,
              t,
              n
            ) {
      ...
      "39BI": [
        function (require, module, exports) {
          ...
          (exports.SVGNS = "http://www.w3.org/2000/svg"),
            ...
            (initial_MJDRange = [exports.epochMJD, exports.endMJD]), //工事中
            //ページのタイトルを表示
      ...
      g9pg: [
        function (require, module, exports) {
          ...
          exports.default_binsize = choice_binsize;
          //binsizeの初期設定
          (exports.filterBinSize = function (e) {
            ...
            (exports.filterPlotType = function (t) {
              return i.isAvailablePlotType(t) ? t : choice_PlotType;
            }),
              ...
              return {
                ...
                toString: function (e) {
                  ...
                  return new Date(e).toISOString().slice(0, -1).slice(11, 23) ==
                    ...
                    : new Date(e).toISOString().slice(0, -1).slice(11, 23);
                  //new Date(e).toISOString(); //new Date(e).getTime() / 1000; //秒で表示にするために1000で割る。
                },
              };
            }
            return null;
            ...
            (exports.getHourTicks = function (t, r, n) {
              ...
              if (u) {
                ...
                return {
                  ...
                  toString: function (e) {
                    num.push(
                      new Date(e).toISOString().slice(0, -8).slice(0, 10) //発表
                    );
                    // console.log(num);
                    return new Date(e)
                      .toISOString()
                            ...
                            return n.createElement(
                              ...
                              n.createElement("input", {
                                ...
                                onChange: function (e) {
                                  ...
                                  choice_PlotType = e.currentTarget.value;
                                },
                              }),
